...
namespace ReportGenerationServiceTests.ControllerTests
{
    ...
    public class CustomerPreferencesControllerTests
    {
        ...
        public void GetCustomerMarketInfoReport_ValidationError_418()
        {
            ...
            {
                CustomerPreferences = new CustomerPreferencesModel[]
                {
                    new CustomerPreferencesModel
                    {
                        Customer = "A",
            ...
            var preferencesValidationMock = mocks.Create<IValidation<CustomerPreferencesForm>>();
            ...
            var controller = new CustomerPreferencesController(null, preferencesValidationMock.Object);
        ...
        public void GetCustomerMarketInfoReport_Success()
        {
            ...
            var controller = new CustomerPreferencesController(customerPreferencesGwMock.Object, preferencesValidationMock.Object);
